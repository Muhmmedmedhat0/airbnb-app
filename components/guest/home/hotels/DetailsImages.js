    ...
    {console.log(props.images)}
      <div className={`${style.mainImage}`}>
        <ImageComponent
          ...
          src={`http://localhost:9000/${props.images[0]}`}
          width="800"
          height="410"
        />
      </div>
      ...
      >
        <div className={`${style.spiltImags}`}>
          <ImageComponent
            // src="https://images.unsplash.com/photo-1645395591882-fd6c8eb9aa81?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8Y292ZXJzJTIwc2VlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            // src={props.images[1]}
          src={`http://localhost:9000/${props.images[1]}`}
        ...
        <div className={`${style.spiltImags}`}>
          <ImageComponent
            // src="https://images.unsplash.com/photo-1645395591882-fd6c8eb9aa81?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8Y292ZXJzJTIwc2VlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            // src={props.images[2]}
          src={`http://localhost:9000/${props.images[2]}`}
        ...
        <div className={`${style.spiltImags}`}>
          <ImageComponent
            // src="https://images.unsplash.com/photo-1645395591882-fd6c8eb9aa81?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8Y292ZXJzJTIwc2VlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            // src={props.images[3]}
          src={`http://localhost:9000/${props.images[3]}`}
        ...
        <div className={`${style.spiltImags}`}>
          ...
          src={`http://localhost:9000/${props.images[4]}`}
            width="280"
            height="140"
          />
        </div>
